...
function LastUpdatedDate({covidData}) {
  ...
  return e('bold', {className: 'text-muted'  },
     'Yesterday :  ',
     e('span', {className: 'badge badge-success '}, lastUpdatedDate)
  );
}
  ...
  return (
    e('form', {className: 'form-inline'},
      e('div', {className: 'form-group mr-3 mb-2'},
        e(CountrySearch, {countrySearchQuery, onCountrySearch, text:'Enter Country Name'})
      ),
      // e('button', {className: 'btn btn-dark mb-2', onClick: CountrySearch},
      //   e('i', {className: 'fas fa-search '}),
      //   ' Search'
      // )
       e('div', {className: 'form-group form-check mr-3 mb-2'},
         e(Toggle, {checked: groupByCountry, onChange: onGroupByCountries, text: 'Select countries'})
      ),
      //  e('div', {className: 'form-group form-check mr-3 mb-2'},
